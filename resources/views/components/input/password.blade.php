...
>
    <input
        ...
        {{ $attributes }}
        class="
            w-full px-2 py-2.5 pr-12 rounded border border-stone-200 bg-stone-50 outline-none text-sm transition-colors duration-300
            focus:border-stone-500 focus:bg-stone-100
